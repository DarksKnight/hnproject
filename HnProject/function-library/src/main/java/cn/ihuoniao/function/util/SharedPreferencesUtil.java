...
public class SharedPreferencesUtil {
    ...
    public static void saveObject(String fileName, Context context, String key, Object obj) {
        try {
            // 保存对象
    ...
    public Object readObject(String fileName, Context context, String key) {
        try {
